...
export const CONFORMITY_ASSESSMENT_OBLIGATIONS = {
  O1: { category: "O", number: "O1", route: "Internal Control", title: "Identify harmonized standards", description: "Identify applicable harmonized standards", source: { article: "Article 41", annex: "Annex V" } },
  O2: { category: "O", number: "O2", route: "Internal Control", title: "Document chosen standards", description: "Document selected standards", source: { article: "Annex V" } },
  O3: { category: "O", number: "O3", route: "Internal Control", title: "Verify compliance with Articles 8–15", description: "Verify compliance with legal requirements", source: { article: "Article 43(1)", annex: "Annex V" } },
  ...
  O6: { category: "O", number: "O6", route: "Internal Control", title: "Prepare Declaration of Conformity", description: "Prepare EU Declaration of Conformity", source: { article: "Article 47", annex: "Annex V" } },
  ...
  O11: { category: "O", number: "O11", route: "Internal Control", title: "Retain documentation 10 years", description: "Maintain documentation for 10 years", source: { article: "Article 18" } },
  O12: { category: "O", number: "O12", route: "Internal Control", title: "Assign responsible officer", description: "Designate responsible person for regulatory compliance", source: { article: "Article 16(1)(i)" } },
  O13: { category: "O", number: "O13", route: "Notified Body", title: "Select Notified Body", description: "Select appropriate Notified Body", source: { article: "Article 43(2)", annex: "Annex VI or VII" } },
  O14: { category: "O", number: "O14", route: "Notified Body", title: "Submit all technical docs", description: "Submit technical documentation", source: { annex: "Annex VI or VII" } },
  O15: { category: "O", number: "O15", route: "Notified Body", title: "Submit system design", description: "Submit system design documentation", source: { annex: "Annex IV" } },
  ...
  O17: { category: "O", number: "O17", route: "Notified Body", title: "Submit training/testing docs", description: "Submit training and testing documentation", source: { annex: "Annex IV" } },
  O18: { category: "O", number: "O18", route: "Notified Body", title: "Submit performance metrics", description: "Submit performance metrics", source: { annex: "Annex IV" } },
  ...
  O21: { category: "O", number: "O21", route: "Notified Body", title: "Submit cybersecurity file", description: "Submit cybersecurity documentation", source: { article: "Article 15" } },
  O22: { category: "O", number: "O22", route: "Notified Body", title: "Submit logging architecture", description: "Submit logging system architecture", source: { article: "Article 12" } },
  O23: { category: "O", number: "O23", route: "Notified Body", title: "Undergo design exam", description: "Undergo Notified Body design examination", source: { annex: "Annex VI or VII" } },
  O24: { category: "O", number: "O24", route: "Notified Body", title: "Implement NB corrective actions", description: "Implement Notified Body recommendations", source: { annex: "Annex VI or VII" } },
  O25: { category: "O", number: "O25", route: "Notified Body", title: "Maintain NB certificates", description: "Maintain certificates from Notified Body", source: { annex: "Annex VI or VII" } },
  ...
  O27: { category: "O", number: "O27", route: "Common Specifications", title: "Document use of CS", description: "Document use of Common Specifications", source: { article: "Article 41" } },
  O28: { category: "O", number: "O28", route: "Common Specifications", title: "Map CS to system", description: "Map specifications to system components", source: { article: "Article 41" } },
  O29: { category: "O", number: "O29", route: "Common Specifications", title: "Implement CS controls", description: "Implement all required controls", source: { article: "Article 41" } },
  O30: { category: "O", number: "O30", route: "Common Specifications", title: "Validate compliance", description: "Validate full compliance", source: { article: "Article 41" } },
  O31: { category: "O", number: "O31", route: "Common Specifications", title: "Document compliance", description: "Document compliance evidence", source: { article: "Article 41" } },
  ...
  O35: { category: "O", number: "O35", route: "Common Specifications", title: "Maintain documentation", description: "Maintain documentation", source: { article: "Article 18" } },
  ...
  O37: { category: "O", number: "O37", route: "Sectoral Legislation", title: "Identify sectoral law", description: "Identify applicable sectoral legislation", source: { article: "Article 6(1)" } },
  ...
  O39: { category: "O", number: "O39", route: "Sectoral Legislation", title: "Include AI‑specific requirements", description: "Include AI-specific requirements (Articles 8-15)", source: { article: "Article 6(2)" } },
  O40: { category: "O", number: "O40", route: "Sectoral Legislation", title: "Provide safety docs", description: "Provide safety documentation", source: { article: "Article 43(3)" } },
  O41: { category: "O", number: "O41", route: "Sectoral Legislation", title: "Provide cybersecurity docs", description: "Provide cybersecurity documentation", source: { article: "Article 15" } },
  O42: { category: "O", number: "O42", route: "Sectoral Legislation", title: "Provide logging docs", description: "Provide logging documentation", source: { article: "Article 12" } },
  O43: { category: "O", number: "O43", route: "Sectoral Legislation", title: "Undergo design exam", description: "Undergo design examination", source: { article: "Article 43(3)" } },
  O44: { category: "O", number: "O44", route: "Sectoral Legislation", title: "Undergo audits", description: "Undergo compliance audits", source: { article: "Article 43(3)" } },
  O45: { category: "O", number: "O45", route: "Sectoral Legislation", title: "Implement findings", description: "Implement audit findings", source: { article: "Article 43(3)" } },
  O46: { category: "O", number: "O46", route: "Sectoral Legislation", title: "Prepare sector declarations", description: "Prepare sectoral declarations", source: { article: "Article 47" } },
  O47: { category: "O", number: "O47", route: "Sectoral Legislation", title: "Register in sector DB", description: "Register in sectoral database", source: { article: "Article 43(3)" } },
  ...
  O49: { category: "O", number: "O49", route: "Sectoral Legislation", title: "Retain docs", description: "Retain all documentation", source: { article: "Article 18" } },
  O50: { category: "O", number: "O50", route: "Sectoral Legislation", title: "Provide authority access", description: "Provide access to authorities", source: { article: "Article 64" } },
};
